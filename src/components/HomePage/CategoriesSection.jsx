...
export function CategoriesSection({ categories, setSelectedCategory }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 font-inter">
            Discover our premium selection across all departments
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {categories.map((category) => (
            <button
              ...
              className="group relative overflow-hidden rounded-2xl bg-white border-2 border-gray-100 hover:border-green-200 transition-all duration-300 hover:shadow-xl"
            >
